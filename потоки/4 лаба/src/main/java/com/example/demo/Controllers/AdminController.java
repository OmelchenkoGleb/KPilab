...
public class AdminController {
    ...
    public String Edit(@PathVariable(value = "id") Long id, @RequestParam String username, @RequestParam String password, Model model){
        admin admin1 = adminRepository.findByUsername(username);
        if(admin1 != null) return "redirect:/admin";
        int i = adminDao.Update(id,username,password);
        return "redirect:/admin";
    }
